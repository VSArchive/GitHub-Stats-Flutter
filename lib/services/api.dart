...
//
  ...
  Future<void> followaUser(String username, String authUsername) async {
    String url =
        'https://api.github.com/user/$authUsername/following/$username';
    String url2 = "https://api.github.com/user/$authUsername/followers";
    try {
