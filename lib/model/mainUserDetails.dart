...
//
//     final MainUserModel = MainUserModelFromJson(jsonString);

import 'dart:convert';

MainUserModel userModelFromJsonX(String str) => MainUserModel.fromJson(json.decode(str));

String userModelToJsonX(MainUserModel data) => json.encode(data.toJson());
